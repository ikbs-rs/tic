...
const postFunction = async (req, res) => {
  try {
    ...
    const item = await sHelper.postFunction( req.query.att||0, req.query.objName1||0, req.query.objName2||0, req.query.objId1||0, req.query.objId2||0, req.query.stm||0, req.query.begda||0, req.query.endda||0, req.query.sl||'en' );
    res.status(200).json({ item }); 
  } catch (err) {
